...
Para más detalles sobre `settingSources`/`setting_sources`, consulta la [referencia del SDK de TypeScript](/docs/en/agent-sdk/typescript#setting-source) o la [referencia del SDK de Python](/docs/en/agent-sdk/python#setting-source).
...
### Recursos del SDK
- [Subagents in the SDK](/docs/en/agent-sdk/subagents): Agentes similares basados en el sistema de archivos con opciones programáticas
- [Slash Commands in the SDK](/docs/en/agent-sdk/slash-commands): Comandos invocados por el usuario
