...
- [Slash Commands](/docs/en/agent-sdk/slash-commands) - Uso de comandos slash en el SDK
- [Subagents](/docs/en/agent-sdk/subagents) - Trabajo con agentes especializados
- [Skills](/docs/en/agent-sdk/skills) - Uso de Agent Skills
