...
- [Inicio rápido](/docs/en/agent-sdk/quickstart) — Construye un agente que corrige errores en minutos
...
**¿Listo para construir?** Sigue el [Inicio rápido](/docs/en/agent-sdk/quickstart) para crear un agente que encuentre y corrija errores en minutos.
...
| **[AskUserQuestion](/docs/en/agent-sdk/user-input#handle-clarifying-questions)** | Formula preguntas de aclaración al usuario con opciones de respuesta múltiple |
...
[Más información sobre hooks →](/docs/en/agent-sdk/hooks)
...
[Más información sobre subagentes →](/docs/en/agent-sdk/subagents)
...
[Más información sobre MCP →](/docs/en/agent-sdk/mcp)
...
> **Nota:** Para los prompts de aprobación interactiva y la herramienta `AskUserQuestion`, consulta [Gestionar aprobaciones y entrada del usuario](/docs/en/agent-sdk/user-input).
...
[Más información sobre permisos →](/docs/en/agent-sdk/permissions)
...
[Más información sobre sesiones →](/docs/en/agent-sdk/sessions)
...
|---------------|-------------|-----------|
| [Skills](/docs/en/agent-sdk/skills) | Capacidades especializadas definidas en Markdown | `.claude/skills/SKILL.md` |
| [Slash commands](/docs/en/agent-sdk/slash-commands) | Comandos personalizados para tareas comunes | `.claude/commands/*.md` |
| [Memory](/docs/en/agent-sdk/modifying-system-prompts) | Contexto e instrucciones del proyecto | `CLAUDE.md` o `.claude/CLAUDE.md` |
| [Plugins](/docs/en/agent-sdk/plugins) | Extiende con comandos, agentes y servidores MCP personalizados | Programático mediante la opción `plugins` |
...
- [Inicio rápido](/docs/en/agent-sdk/quickstart) — Construye un agente que encuentre y corrija errores en minutos
- [Agentes de ejemplo](https://github.com/anthropics/claude-agent-sdk-demos) — Asistente de correo electrónico, agente de investigación y más
